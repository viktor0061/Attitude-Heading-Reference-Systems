...
testRoll(602 : 1800) = pi/3 * sin(2*pi*0.2381*time(602 : 1800));
testPitch(1802 : 3000) = pi/3 * sin(2*pi*0.2381*time(1802 : 3000));
testYaw(3002 : L) = pi/3 * sin(2*pi*0.2381*time(3002 : L));
